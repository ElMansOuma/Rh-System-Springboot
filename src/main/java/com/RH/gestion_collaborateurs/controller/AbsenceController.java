...
import com.RH.gestion_collaborateurs.payload.StatusUpdateRequest;
...
public class AbsenceController {
    ...
    public ResponseEntity<Absence> updateAbsenceStatus(
        ...
        Absence updatedAbsence = absenceService.updateAbsenceStatus(id, request.getStatus(), request.getObservations());
        return ResponseEntity.ok(updatedAbsence);
    }
